...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('assists', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('pays_id')->nullable();/* unique hace que se ligue 1 a 1.no 2 a 1, ni 1 a 2 | ->nullable() si necesitas consevar el post[->set null] */
            $table->foreign('pays_id')
                ->references('id')
                ->on('pays')/* para que actualice el id */
                ->onUpdate('cascade')
